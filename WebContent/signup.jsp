...
<body>
	...
	<div class="panel panel-default" style="margin: 50px;">
		<div class="panel-body">
			...
			<form action="registration.do" method=get class=container>
				...
				<div class=form-group>
					<label for="passworld">비밀번호 재확인</label> <input
						type="password-check" class="form-control" name=password-check
						id=password-check>
				</div>
